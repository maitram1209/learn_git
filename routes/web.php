...
Route::get('/search', 'PagesController@productlist')->name('get.product.list');
// auth
Auth::routes();
// member 
...
Route::group(['prefix' => 'admin/sanpham'], function() {
    ...
    // -------------------- quan ly danh gia--------------------
Route::group(['prefix' => 'admin/danhgia'], function() {
Route::get('/del/{id}',['as'  =>'getdellra','uses' => 'AdminRatingController@getdel'])->where('id','[0-9]+');
