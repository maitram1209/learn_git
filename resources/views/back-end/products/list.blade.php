						...
						<div class="table-responsive">
							<table class="table table-hover">
								...
								<tbody>
									...
									<?php 
										$age = 0;
										if($row->pro_total_rating){
											$age = round($row->pro_total_number/$row->pro_total_rating,2);
										}
										
									?>
										<tr>
											<td>{!!$row->id!!}</td>
											<td> <img src="{!!url('public/uploads/products/'.$row->images)!!}" alt="phone" width="50" height="40"></td>
											<td>{!!$row->name!!}</td>
											<td class="rating" style="width:110px">
												@for($i=1;$i<=5;$i++)
